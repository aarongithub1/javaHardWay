public class RandomNumbers {
  public static void main(String[] args) {
    ...
    //picks random numbers from 1-3
    int j = 1 + (int)(3*Math.random());
    int k = 1 + (int)(3*Math.random());
    int l = 1 + (int)(3*Math.random());
    System.out.println("1-3:\t" + j + "\t" + k + "\t" + l);

    //picks random numbers from 5-10
    int x = 5 + (int)(6*Math.random());
    int y = 5 + (int)(6*Math.random());
    int z = 5 + (int)(6*Math.random());
    System.out.println("5-10:\t" + x + "\t" + y + "\t" + z);
