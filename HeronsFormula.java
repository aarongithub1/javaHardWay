public class HeronsFormula {
    ...
    public static double triangleArea(int a, int b, int c) {
        ...
        //After computing the area, you must return th computed value
        return A;
    }

    //The program without Functions is longer than this one.
    //s = (a+b+c) / 2.0 would have needed to be changed many times in the other program.
    //would have taken more edits to change in the other program
